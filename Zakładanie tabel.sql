...
CREATE TABLE [dbo].[Stacja](
	...
	[Data Uruchomienia] [datetime] NULL,
	[Data Zamknięcia] [datetime] NULL,
	[Współrzędne Północ] decimal(10,5) NULL,
	[Współrzędne Wschód] decimal(10,5) NULL,
	[Typ StacjiId] [int] NULL,
	[Typ ObszaruId] [int] NULL,
	[Rodzaj StacjiId] [int] NULL,
	[WojewództwoId] [int] NULL,
	[MiastoId] [int] NULL,
PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
GO
ALTER TABLE [dbo].[Stacja]  WITH CHECK ADD  CONSTRAINT [FK_Stacja_Województwo] FOREIGN KEY([WojewództwoId])
